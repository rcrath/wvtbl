# b_menu.py - FIXED v2
# Addresses issue #36 (filename sanitization) and directory creation bug
...
def run():
    ...
    # FIX: Always ensure tmp folder and subdirectories exist before copying
    # This is the key fix - create directories after cleanup or if they don't exist
    aa_common.ensure_tmp_folder()
    
    # Also ensure the cpy subfolder exists
    # This is critical - the cpy_folder path comes from aa_common.get_cpy_folder()
    # but that might just return a path, not create the directory
    ...
    # Now copy files - this should work because directories exist
