...
wav_file = "flange220\\tmp\\concat\\flange220_2048_all.wav"  # Define wav_file at the module level
...
def find_nearest_rising_zero_crossing(data, index):
    for i in range(index, index + 256):
...
# Integrate and test
plot_wav_file_interactive(wav_file)
if selected_segment is not None:
    save_selection(selected_segment, selected_sr)  # Use global sample rate
else:
