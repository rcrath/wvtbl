...
def adjust_sample_rate_based_on_wavecycle_length(input_file_path, target_length, output_folder):
    ...
    if target_sr != original_sr:
        data_resampled = resampy.resample(data, sr_orig=original_sr, sr_new=target_sr)
        ...
        sf.write(output_file_path, data_resampled, target_sr, subtype='FLOAT')
        ...
        sf.write(output_file_path, data, original_sr, subtype='FLOAT')
